...
public class Demo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        VoronoiGraph voronoiGraph = VoronoiGraph.FromDCEL(engine.dcel);
        WriteVoronoiToFile(voronoiGraph);
    }

    private void WriteVoronoiToFile(VoronoiGraph voronoiGraph)
    {
        StringBuilder sb = new StringBuilder();
        foreach (var e in voronoiGraph.edgeList)
        {
            sb.Append($"{e.start.x},{e.start.y}\n{e.end.x},{e.end.y}\n\n");
        }
        
        foreach (var f in voronoiGraph.faceList)
        {
